   ...
   class WXDLLIMPEXP_WXAUTOEXCEL wxExcelRange : public wxExcelRangeOwner
    ...
    public:
        ...
        */
        bool GetShowDetail();
        /**
        Returns true if the text shrinks to fit into the cell.
